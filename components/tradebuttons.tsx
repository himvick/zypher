...
const TradeButtons = () => {
  return (
    <div className="flex flex-row items-center gap-2 sm:gap-4 p-2 sm:p-4 w-full">
      <Link
        href="/home/buy"
        className="border border-gray-600 rounded-3xl p-2 sm:p-3 items-center hover:bg-gray-800"
      >
      ...
      <Link
        href="/home/receive"
        className="border border-gray-600 rounded-3xl p-2 items-center hover:bg-gray-800"
      >
